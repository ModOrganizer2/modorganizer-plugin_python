...
namespace utils {
    ...
    namespace QString_converter {
        ...
        struct QString_from_python_str {
                                  ...
                                  bpy::converter::rvalue_from_python_stage1_data* data)
            {
                ...
                // allocate storage
                void* storage =
                    ((bpy::converter::rvalue_from_python_storage<QString>*)data)
                        ->storage.bytes;
    ...
    namespace Enum_converter {
        ...
        struct Enum_from_python_obj {
                                  ...
                                  bpy::converter::rvalue_from_python_stage1_data* data)
            {
                ...
                void* storage =
                    ((bpy::converter::rvalue_from_python_storage<Enum>*)data)
                        ->storage.bytes;
    ...
    namespace QFlags_converter {
        ...
        struct QFlags_from_python_obj {
                                  ...
                                  bpy::converter::rvalue_from_python_stage1_data* data)
            {
                ...
                void* storage =
                    ((bpy::converter::rvalue_from_python_storage<QFlags<T>>*)data)
                        ->storage.bytes;
    ...
    namespace QVariant_converter {
        ...
        struct QVariant_from_python_obj {
            ...
            {
                void* storage =
                    ((bpy::converter::rvalue_from_python_storage<QVariant>*)data)
                        ->storage.bytes;
    ...
    namespace QClass_converter {
        ...
        struct QClass_converters {
            struct QClass_to_PyQt {
                template <typename Q>
                static typename std::enable_if_t<std::is_copy_constructible_v<Q>, T*>
                ...
                static PyObject* convert(const T& object)
                {
                    const sipTypeDef* type =
                        sipAPIAccess::sipAPI()->api_find_type(MetaData<T>::className());
                    if (type == nullptr) {
                        return bpy::incref(Py_None);
                    }

                    PyObject* sipObj = sipAPIAccess::sipAPI()->api_convert_from_type(
                        (void*)getSafeCopy<T>((T*)&object), type, 0);
                    if (sipObj == nullptr) {
                        return bpy::incref(Py_None);
                    }
    ...
    struct downcast_return {
        ...
        struct apply_<std::shared_ptr<T>> {
            static_assert(
                std::is_convertible_v<std::shared_ptr<T>, std::shared_ptr<FromType>>);
    ...
    inline void register_qflags_converter()
    {
        ...
        bpy::converter::registry::push_back(&QFlags_from_python_obj<T>::convertible,
    ...
    inline void register_enum_converter()
    {
        ...
        bpy::converter::registry::push_back(&Enum_from_python_obj<Enum>::convertible,
